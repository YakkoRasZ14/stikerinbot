...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/YakkoRasZ14/stikerinbot)
...
```bash
git clone https://github.com/YakkoRasZ14/stikerinbot
cd wabot-aq
npm install
npm update
```
